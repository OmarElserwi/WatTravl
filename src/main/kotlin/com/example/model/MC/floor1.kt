...
fun setDistances(hallways: Map<Int, HallwayNode>) {
    // Example distances, adjust based on actual requirements
    globalDistances[hallways[101]!! to hallways[102]!!] = 10
    globalDistances[hallways[102]!! to hallways[101]!!] = 10
    globalDistances[hallways[102]!! to hallways[103]!!] = 15
    globalDistances[hallways[103]!! to hallways[102]!!] = 15
}
